...
class StyleNeusRendererFix(RendererBase):
    """
    ...
    def __init__(
        ...
        self.transforms.requires_grad = False
        self.deviations.requires_grad = False
    ...
    def produce_parameters(self, shape_code: torch.Tensor, color_code: torch.Tensor, style_code: torch.Tensor):
        ...
        parameters.extend(self.volumetric_function.produce_parameters(style_code))#color

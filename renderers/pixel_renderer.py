...
class PixelRenderer(RendererBase):
    def __init__(
            self,
        ...
        # Encoder
        self.encoder = PixelEncoder(**encoder_config)
        for module in self._implicit_function.values():
            module.set_encoder_net(self.encoder)
    ...
    def forward(
        ...
        # encode source views
        self.encoder.encode(source_image, source_camera)

...
@IMPLICIT_FUNCTIONS.register_module(name='as2_neus_mlp_cat')
class AS2NeusMlpCat(HyperNetwork):
    """
    ...
    def __init__(
        ...
        Initialize
        """
        super(AS2NeusMlpCat, self).__init__()

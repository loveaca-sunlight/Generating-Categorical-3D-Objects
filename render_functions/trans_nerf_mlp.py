...
@IMPLICIT_FUNCTIONS.register_module(name='transnerf_mlp')
class TransNerfMlp(torch.nn.Module):
    def __init__(
            self,
    ...
    def forward(
        ...
        Args:
            ...
            transform_code: code for transform points, (1, dt)
            density_noise_std: float = 0.0
        ...
        if transform_code is not None:
            ...
            assert not self.training, 'transform code can not be None in training.'

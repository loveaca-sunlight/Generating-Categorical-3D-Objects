...
from renderers import StyleNeusRendererAdd
...
@MODELS.register_module(name='style_neus_add_model')
class StyleNeusAddModel(pl.LightningModule):
    def __init__(self, cfg, sequences: typing.List[str], load_pretrained_weights=True, style_data='train', **kwargs):
        super(StyleNeusAddModel, self).__init__()
        ...
        self.model = StyleNeusRendererAdd(
            sequences=sequences,

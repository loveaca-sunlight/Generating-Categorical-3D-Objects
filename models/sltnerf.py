...
from renderers import SilhouetteRenderer
from .registry import MODELS
from .util import mask_image, select_key_points
from torch.optim import Optimizer


@MODELS.register_module(name='slt_nerf_model')
class SltNerfModel(pl.LightningModule):
    def __init__(self, cfg, sequences: typing.List[str], resume: bool = False):
        super(SltNerfModel, self).__init__()
        ...
        #坐标系转化统一除八  ！！！会导致transform问题
        key_points = {k:i / 8. for k,i in key_points.items()}

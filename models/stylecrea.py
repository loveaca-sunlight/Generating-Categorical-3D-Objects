...
from renderers import StyleNeusRenderer, StyleCreaRenderer
...
@MODELS.register_module(name='style_crea_model')
class StyleCreaModel(pl.LightningModule):
    def __init__(self, cfg, sequences: typing.List[str], load_pretrained_weights=True, style_data='train', **kwargs):
        super(StyleCreaModel, self).__init__()
    ...
    def forward(
            ...
            style_img1: torch.Tensor = None,
            style_img2: torch.Tensor = None,
        ...
        return self.model(
            ...
            style_image1=style_img1,
            style_image2=style_img2,

...
from renderers import StyleNeusRendererCatLinear
...
@MODELS.register_module(name='style_neus_cat_linear_model')
class StyleNeusCatLinearModel(pl.LightningModule):
    def __init__(self, cfg, sequences: typing.List[str], load_pretrained_weights=True, style_data='train', **kwargs):
        super(StyleNeusCatLinearModel, self).__init__()
        ...
        self.model = StyleNeusRendererCatLinear(
            sequences=sequences,

...
from renderers import StyleNeusRendererEncoder
...
@MODELS.register_module(name='style_neus_encoder_model')
class StyleNeusEncoderModel(pl.LightningModule):
    def __init__(self, cfg, sequences: typing.List[str], load_pretrained_weights=True, style_data='train', **kwargs):
        super(StyleNeusEncoderModel, self).__init__()
        ...
        self.model = StyleNeusRendererEncoder(
            sequences=sequences,
    ...
    def configure_optimizers(self):
        ...
        param_groups = [
            ...
            {'params': self.model.encoder3_parameters(),
             'lr': self.cfg.optimizer.encoder3_lr},
    ...
    def training_step(self, batch_data, batch_idx):
        ...
        # log
        for key in ['style_loss', 'content_loss', 'rgb_loss', 'color_loss']:
